...
class BoxTest extends TestCase
{
    ...
    public function test_getColumn()
    {
        ...
        $this->assertEquals(['a', 'd', 'g'], array_map(function(Element $element){ return $element->getName(); }, $box->getColumn(0)));
        $this->assertEquals(['b', 'e', 'h'], array_map(function(Element $element){ return $element->getName(); }, $box->getColumn(1)));
    }
}
