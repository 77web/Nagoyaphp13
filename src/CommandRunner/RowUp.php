...
class RowUp implements CommandRunnerInterface
{
    ...
    {
        return $command->getTargetType() === Command::TARGET_TYPE_ROW && $command->getDirection() === Command::DIRECTION_UP;
    }
